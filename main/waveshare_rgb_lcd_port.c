...
/**************************************************************************************************/
/** @fcn        IRAM_ATTR static bool rgb_lcd_on_vsync_event(esp_lcd_panel_handle_t panel, const esp_lcd_rgb_panel_event_data_t *edata, void *user_ctx)
 *  @brief      VSYNC event callback function
 *  @details    x
 *
 *  @param    [in]  (esp_lcd_panel_handle_t) panel - x
 *  @param    [in]  (const esp_lcd_rgb_panel_event_data_t *) edata - x
 *  @param    [in]  (void *) user_ctx - x
 *
 *  @return (bool) descrip
 */
/**************************************************************************************************/
IRAM_ATTR static bool rgb_lcd_on_vsync_event(esp_lcd_panel_handle_t panel, const esp_lcd_rgb_panel_event_data_t *edata, void *user_ctx) {
	...
	//Locals
	bool stat;									    /* Whether a lvgl yield is needed             */
	
	//Handle
	stat = lvgl_port_notify_rgb_vsync();
...
/**************************************************************************************************/
/** @fcn        static esp_err_t i2c_master_init(void)
...
static esp_err_t i2c_master_init(void) {
    ...
    esp_err_t stat;									/* sdk response values						  */
    ...
    // Install I2C driver
    stat = i2c_driver_install(i2c_master_port, 
						      i2c_conf.mode, 
						      0,
						      0,
						      0);
...
/**************************************************************************************************/
/** @fcn        esp_err_t wavesahre_rgb_lcd_bl_on(void)
 *  @brief      Turn on the screen backlight
 *  @details    x
 */
/**************************************************************************************************/
...
/**************************************************************************************************/
/** @fcn        esp_err_t wavesahre_rgb_lcd_bl_off(void)
 *  @brief      Turn off the screen backlight
 *  @details    x
 *
 *  @return   (esp_err_t) descrip
 */
...
/**************************************************************************************************/
/** @fcn        static void draw_event_cb(lv_event_t *e)
...
/**************************************************************************************************/
/** @fcn        static void add_data(lv_timer_t *timer)
 *  @brief      Timer callback to add data to the chart
 *  @details    x
 *
 *  @param    [in]  (lv_timer_t *) timer - x
 *
 *	@section 	Opens
 *		No magic nums
 */
...
static void add_data(lv_timer_t *timer) {
    ...
    lv_chart_set_next_value2(chart,			        /* Add random data to the chart               */
                             lv_chart_get_series_next(chart, NULL),
                             lv_rand(0, 200),
                             lv_rand(0, 1000)); 
    return; 
}
